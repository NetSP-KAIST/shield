...
THRESHOLD_ICMPQ         = 3000
THRESHOLD_UDP           = 2050
THRESHOLD_DNSQ          = 3500
THRESHOLD_SYN           = 2150

GLOBAL_TIME1            = 34        # about 16 seconds
GLOBAL_TIME2            = 35        # about 32 seconds
GLOBAL_TIME3            = 36        # about 64 seconds

RECIRC_PORT             = 68
PORT_M                  = 192

PTF_TEST                = 1         # 1 is for PTF test, otherwise 0
SOFTWARE                = 1         # 1 is on software, otherwise 0
    ...
    if do_block:
        ...
        for i, table_list in enumerate(block_thresholds_table): # arr0-1
            for j, table in enumerate(table_list):              # slice0-3
                keys = []
                datas = []
                for k in range(min(THRESHOLDS[j], 2**(LAYER1_BIT_SIZE+LAYER2_BIT_SIZE+LAYER3_BIT_SIZE-3))):
